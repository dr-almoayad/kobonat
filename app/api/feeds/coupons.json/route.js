...
export const revalidate = 1800; // Still works for ISR after first request
...
export async function GET() {
  try {
    ...
    console.error('[API /feeds/coupons.json] Error:', error);
    return NextResponse.json(
      { error: 'Failed to generate coupons feed' },
      { status: 500 }
    );
  }
}
