...
const alexandria = Alexandria({ subsets: ["arabic"], weight: ["100", "900"], variable: "--font-alexandria", display: 'swap' });
const openSans = Open_Sans({ subsets: ["latin"], weight: ["300", "800"], variable: "--font-open-sans", display: 'swap' });
