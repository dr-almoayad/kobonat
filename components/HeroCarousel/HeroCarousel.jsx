...
const HeroCarousel = ({ 
  ...
  showOverlay = true,
  showContent = true,
  height = '600px', // Taller default for better impact
  showDots = true,
  showArrows = true
}) => {
  ...
  const onScroll = useCallback(() => {
    ...
    const styles = emblaApi.scrollSnapList().map((scrollSnap, index) => {
      ...
      // Handle loop logic for smooth scrolling across edges
      ...
      // Parallax intensity (15% movement relative to scroll)
      return diffToTarget * (-15) + "%";
    });
  ...
  const onSelect = useCallback(() => {
    ...
    // Reset autoplay timer on manual interaction (optional visual cue)
  ...
  return (
    <div className="hero-carousel-wrapper" style={{ '--carousel-height': height }} dir={isRtl ? 'rtl' : 'ltr'}>
        ...
        {showDots && images.length > 1 && (
          <div className="hero-carousel__dots">
            {scrollSnaps.map((_, index) => (
              ...
              >
                {/* Visual Progress Bar for Active Dot */}
