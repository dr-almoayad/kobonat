...
function generateHreflangAlternates(slug) {
  // ✅ FIX: Only declare hreflang for locales that actually have pages on
  // this site. Declaring ar-AE, en-EG, ar-QA etc. when those URLs return
  // 404 or redirect is worse than no hreflang — Google treats it as an
  // error and may ignore the entire hreflang set.
  return {
